...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#divWeatherMain {\n  display: block;\n  border-radius: 10px;\n  width: 300px;\n  height: 280px;\n  background: black;\n  background: linear-gradient(180deg, black 0%, #08072a 75%, #080a3f 100%);\n  color: white;\n  font-family: \"Segoe UI\", Tahoma, Geneva, Verdana, sans-serif;\n}\n\n#divWeatherMain2 {\n  display: block;\n  border-radius: 10px;\n  width: 200px;\n  height: 220px;\n  background: black;\n  background: linear-gradient(180deg, black 0%, #08072a 75%, #080a3f 100%);\n  color: white;\n  font-family: \"Segoe UI\", Tahoma, Geneva, Verdana, sans-serif;\n}\n\n.weatherWidgetRow {\n  display: block;\n  margin: 0 auto;\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n}\n\n.sun {\n  margin-top: 10px;\n  color: yellow;\n  filter: drop-shadow(1px 1px 10px yellow);\n}\n\n.moon {\n  margin-top: 10px;\n  color: white;\n  filter: drop-shadow(1px 1px 10px white);\n}\n\n.cloudDiv {\n  margin-top: -40px;\n}\n\n.cloud {\n  color: #68afc5;\n  filter: drop-shadow(1px 1px 5px #68afc5);\n  animation-name: cloudMovement;\n  animation-iteration-count: infinite;\n  animation-duration: 10s;\n  animation-timing-function: ease-in-out;\n  animation-direction: alternate;\n}\n\n@keyframes cloudMovement {\n  from {\n    margin-left: -55px;\n  }\n  to {\n    margin-left: 65px;\n  }\n}\n\n@media (max-width: 900px) {\n  .fontmobile {\n    font-size: 20px !important;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let Tab2Page = class Tab2Page {
    ...
    crearGrafuciBarras() {
        this.barChart = new chart_js__WEBPACK_IMPORTED_MODULE_5__["Chart"](this.barCanvas.nativeElement, {
            type: "bar",
            data: {
                labels: this.historicoFechas,
                datasets: [
                    {
                        label: "HISTORICO TEMEPERATURA",
                        data: this.historico,
    ...
    getData() {
        ...
        this.testService.exteriorTemperatura(this.ambiente).subscribe(res => {
            if (res.hasOwnProperty('error')) {
                ...
                let count = 0;
                var valoresAceptados = [1, 20, 40, 60, 80, 100];
                this.ultimasdiez.forEach(element => {
                    count++;
                    if (valoresAceptados.indexOf(count) > -1 && element.value < 80) {
                    ...
                    if (element.value < 20)
                        ...
                        this.colores.push("rgba(255, 99, 132, 0.2)");
                });
                this.crearGrafuciBarras();
            }
        }, error => {
            console.log(error);
        });
    ...
    getDataambiente2() {
        this.testService.exteriorTemperatura2().subscribe(res => {
            console.log("la dos");
            console.log(res);
